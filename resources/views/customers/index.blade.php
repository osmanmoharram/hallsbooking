        ...
        <div class="flex items-center justify-end px-2 py-2">
            ...
            <div class="flex items-center pe-3 space-s-6">
                <a href="#"
                    ...
                    <span class="font-semibold">{{ __('customers.index.table.sort') }}</span>
                </a>
                <a href="#"
                    class="flex items-center space-s-2 text-gray-700 text-opacity-25 text-xs hover:text-opacity-40 tranisition duration-150 ease-in-out">
                    <span class="block">
                    ...
                    <span class="font-semibold">{{ __('customers.index.table.filter') }}</span>
                </a>
            </div>
        </div>
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col"
                                        ...
                                        {{ __('customers.index.table.cols.name') }}
                                    </th>
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ __('customers.index.table.cols.email') }}
                                    </th>
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ __('customers.index.table.cols.phone') }}
                                    </th>
